...
| AH-2026-05-10-03 | Add request trend area chart to admin dashboard          | Done        | Added shadcn/ui with recharts, new `getRequestTrends` data function, and full-width interactive area chart below stat cards with 1m/3m/6m/1y/YTD time range filters.                                                      | 2026-05-10   |
| AH-2026-05-10-04 | Remove redundant CTA section from request-quote page     | Done        | Removed the "Prefer to speak with the shop first?" CtaSection from the request-quote page since the user is already on the request form page.                                                                             | 2026-05-10   |
| AH-2026-05-10-05 | Fix admin dashboard styling                              | Done        | Updated request trends chart to use standard admin-card layout and fixed TypeDonut card padding for even distribution.                                                                                                    | 2026-05-10   |
| AH-2026-05-10-06 | Fix edit/view button hover text contrast in admin tables | Done        | Changed hover text color from `hover:text-white` to `hover:text-[#ffffff]` on the services Edit button and requests View button so text is visible against the black hover background.                                    | 2026-05-10   |
| AH-2026-05-10-07 | Fix gallery card typography alignment                    | Done        | Changed gallery page card layout from `group grid` to `group flex flex-col` so that text content stays top-aligned beneath the image instead of stretching out vertical whitespace inside the grid item container.        | 2026-05-10   |
| AH-2026-05-10-08 | Fix request status badge review findings                 | Done        | Replaced direct DOM manipulation with React-managed hidden input, fixed stale closure via ref, extracted shared dropdown positioning hook, added keyboard navigation, and aligned next-env.d.ts path.                     | 2026-05-10   |
